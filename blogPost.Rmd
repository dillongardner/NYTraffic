...
### Conclusions
This has shown how STL can be used to assess the seasonal components of a time series. Unsurprisingly, traffic on the JFK bridge shows a strongly weekly seasonality. Sundays are the smallest
